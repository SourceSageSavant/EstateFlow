            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-200">
                    <h2 className="text-xl font-bold text-slate-900">
                        Invite {role === 'tenant' ? 'Tenant' : 'Guard'}
                    </h2>
                    <button
                        onClick={handleClose}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none appearance-none bg-white disabled:bg-slate-100"
                                        >
                                            <option value="">
                                                {!selectedProperty
